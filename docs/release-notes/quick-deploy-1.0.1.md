...
If you need an actual release artifact (tag or site snapshot) created, tell me whether to create a tag (git tag) and/or
prepare a static site snapshot for upload.
