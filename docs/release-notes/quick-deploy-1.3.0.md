...
```bash cd /opt/perfsonar-tp/tools_scripts curl -fsSL https://raw.githubusercontent.com/osghtc/networking/master/docs/perfsonar/tools_scripts/install_tools_scripts.sh | bash -s -- /opt/perfsonar-tp
```text
