...
1. Supports selection between deployment options (testpoint only vs Let's Encrypt).

1. Automatic DNS and certificate validation checkpoints.

1. Exit codes suitable for automation.
